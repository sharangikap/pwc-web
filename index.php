                    ...
                    <div class="col-md-4 animate-box">
                        <article class="article-entry">
                            <a href="news/news.php?id=<?php echo $row["id"]; ?>" class="blog-img">
                                <img src="news/img-news/<?php echo $row["photo"]; ?>" alt="<?php echo $row["photo"]; ?>"><br><br>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="course-item bg-light">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="events/img-events/<?php echo($row["img"]) ?>" alt="<?php echo($row["title"]) ?>">
                        </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="img/principal-pwc.webp" alt=""
                            style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
            ...
            <div class="row g-3">
                ...
                <div class="col-lg-5 col-md-6 wow zoomIn" data-wow-delay="0.7s" style="min-height: 350px;">
                    <a class="position-relative d-block h-100 overflow-hidden" href="sports.php#combat-sports">
                        <img class="img-fluid position-absolute w-100 h-100" src="img/header-main-pwc.jpg" alt=""
                            style="object-fit: cover;">
                        <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3"
                            style="margin:  1px;">
