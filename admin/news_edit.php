...
<div class="container-fluid py-4" style="min-height: 700px;">
    ...
    <div class="card mb-4">
    	<div class="card-header">
       	...
       	<div class="card-body">
		   <form action="{{url('/new/Products-Edit_confirm',$product->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
        		...
        		<div class="row">
        			<div class="col-md-6">
        				<div class="mb-3">
        					...
        					<input type="text" name="title" id="Product_name" class="form-control" value="{{$product->title}}" />
        				</div>
        			</div>
					<div class="col-md-6">
        				<div class="mb-3">
                ...
                @endforeach
					...
					<div class="col-md-6">
        				<div class="mb-3">
        					...
        					<input type="text" name="price_USD" id="Product_isbn_number" class="form-control" value="{{$product->price_USD}}"/>
        				</div>
        			</div>
        			<!--<div class="col-md-6">
        		...
        		<div class="row">
        			<div class="col-md-6">
        				<div class="mb-3">
        					...
        					<input type="text" name="price_lk" id="Product_isbn_number" class="form-control" value="{{$product->price_lk}}"/>
        				</div>
        			</div>
        			<div class="col-md-6">
        				<div class="mb-3">
        					<label class="form-label">Qty</label>
        					<input type="number" name="quantity" id="Product_no_of_copy" step="1" class="form-control"value="{{$product->quantity}}" />
        				</div>
        			</div>
					<div class="col-md-6">
        				<div class="mb-3">
        					<label class="form-label">Images</label>
        					<input type="file" name="image" id="Product_no_of_copy" class="form-control" accept=".jpg, .jpeg, .png, .webp" multiple value="{{$product->image}}"/>
        				</div>
        			</div>
        		</div>
