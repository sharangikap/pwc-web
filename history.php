        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="content/img/img-history/former-principals/sampath-weragoda-former-principals-pwc.webp" alt="Sampath Weragoda">
                        </div>
                        <div class="text-center p-4">
                ...
                <center><a class="btn btn-primary py-3 px-5 mt-2 wow zoomIn" href="history-former-principals.php" style="border-radius=25px"
