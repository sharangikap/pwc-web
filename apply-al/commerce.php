...
<form class= "form-horizontal" method="POST" action="com_insert.php">
     ...
     <div class="form-group">
         ...
         <p style="color:blue;"> Subjects are in Sinhala and English Medium </p>
         <p style="color:blue;"> <b>Accounting </b>and <b>Economics</b> are <b>compulsory</b> for both medium.</p>
         </div> </div>
    <hr>
    <!--Subject Selection-->
  <div class="form-group">
...
<div class="table-responsive-sm">
  ...
  <div class="form-group">
    ...
    <p style= "color:red;">Please CHECK the information you provided are correct BEFORE click on SUBMIT button.
