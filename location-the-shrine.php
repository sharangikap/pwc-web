...
<head>
    <title>The Shrine │ Prince of Wales' College, Moratuwa</title>
    <?php
    $page = 'about';
?>
    ...
    <!-- Primary Meta Tags -->
    <meta name="title" content="The Shrine │ Prince of Wales' College, Moratuwa" />
    ...
    <meta name="keywords"
        content="prince of wales college map, prince of wales college bulidings, prince of wales college shrine. prince of wales college budu madura, thissa hunawardane sir" />

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://princeofwales.edu.lk/location-the-shrine.php" />
    <meta property="og:title" content="The Shrine │ Prince of Wales' College, Moratuwa" />
    ...
    <meta property="twitter:title" content="The Shrine │ Prince of Wales' College, Moratuwa" />
...
<!-- Header Start -->
<div class="container-fluid bg-primary py-5 mb-5 shrine-page-header">
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-lg-10 text-center">
                <h1 class="display-3 text-white animated slideInDown">THE SHRINE</h1>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                ...
                <h6 class="bg-white text-start text-primary ">Written by: Mr. Tissa Gunawardena (the sculptor of the
                    shrine) </h6>
                <p class="mb-4">This shrine is a genuinely exceptional creation and therefore I will have to explain
                    ...
                    irrespective whether rich or poor can reach the Blessed One.<br><br>
                    ...
                    Gala" is the name given to the sculpture.<br><br>
                    ...
                    of the shrine. Here the lotus is sculptured to symbolize "Nirwana".<br><br>
                    ...
                    belong to the "Theravada" tradition which expresses the inner sublimation.<br><br>
                </p>
            </div>
