...
if(isset($_POST["issue_book_button"]))
{
    ...
    {
        $error .= '<li>Book return Day Limit is required</li>';
    }
    else
    {
        $formdata['day_limit'] = trim($_POST['day_limit']);
    }
                        ...
                        foreach($statement->fetchAll() as $user_row)
                        {
                            if($user_row['user_status'] == 'Enable')
                            {
                                ...
                                if($total_book_issue < $book_issue_limit)
                                {
                                    ...
                                    $total_book_issue_day = $formdata['day_limit'];
                ...
                <div class="card-body">
                    <form method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="day_limit" id="day_limit" class="form-control" />
                        </div>
                        <div class="mt-4 mb-0">
                ...
                foreach($result as $row)
                {
                    ...
                    foreach($book_result as $book_data)
                    {
                        ...
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <td>'.$book_data["book_isbn_number"].'</td>
                            </tr>
                            <tr>
                                <th>Book Title</th>
                    ...
                    foreach($user_result as $user_data)
                    {
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th>Index Number</th>
                                <td>'.$user_data["user_unique_id"].'</td>
                            </tr>
                            <tr>
                    ...
                    if($status == "Issue")
                    {
                        ...
                        $form_item = '
                        <label><input type="checkbox" name="book_return_confirmation" value="Yes" /> Mark as Received</label>
                        <br />
                        <div class="mt-4 mb-4">
                    ...
                    if($status == 'Not Return')
                    {
                        ...
                        $form_item = '
                        <label><input type="checkbox" name="book_return_confirmation" value="Yes" /> Mark as Received</label><br />
                        <div class="mt-4 mb-4">
                            <input type="submit" name="book_return_button" value="Book Return" class="btn btn-primary" />
                        </div>
                        ';
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                        <th width="30%">Book Expected Date</th>
