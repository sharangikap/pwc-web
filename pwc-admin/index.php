...
if(isset($_POST["add_book"]))
{
	...
	if(empty($_POST["book_cupboard"]))
	{
		$error .= '<li>Book Cupboard is required</li>';
	}
	else
	{
		$formdata['book_cupboard'] = trim($_POST["book_cupboard"]);
	}
	...
	if($error == '')
	{
		$data = array(
			...
			':book_cupboard'	=>	$formdata['book_cupboard'],
        ...
        (book_category, book_author, book_cupboard, book_name, book_isbn_number, book_no_of_copy, book_status, book_added_on) 
        VALUES (:book_category, :book_author, :book_cupboard, :book_name, :book_isbn_number, :book_no_of_copy, :book_status, :book_added_on)
		";
        		...
        		<div class="row">
        			...
        			<div class="col-md-6">
        				<div class="mb-3">
        					...
        					<select name="book_cupboard" id="book_cupboard" class="form-control">
        						<?php echo fill_cupboard($connect); ?>
        					</select>
        				</div>
        			</div>
        		</div>
    	...
    	<div class="card-header">
       	...
       	<div class="card-body">
       		...
       		<script>
       			...
       			document.getElementById('book_cupboard').value = "<?php echo $book_row['book_cupboard']; ?>";
       		</script>
       	</div>
   	</div>
	<?php
