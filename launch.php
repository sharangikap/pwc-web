        ...
        <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <h1><svg xmlns="http://www.w3.org/2000/svg" width="75" fill="#800000"
                        ...
                        <h1 class="mb-4">Ready To Launch</h1>
                        <p class="mb-4">Get Ready to Experience the Grand Launch of Prince of Wales' College Official
                            Website</p>
                        <a id="launch-button" class="btn btn-primary rounded-pill py-3 px-5 launch-button"
                            href="https://princeofwales.edu.lk">LAUNCH</a>
